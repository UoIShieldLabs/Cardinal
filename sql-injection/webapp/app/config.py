...
class Config:
    ...
    DB_PASSWORD = os.environ.get("DB_PASSWORD", "portal")
    ...
    DESER_SVC_URL = os.environ.get("DESER_SVC_URL", "http://deser-svc:8090/reconstruct")

    # --- Per-condition attack-surface defaults ---------------------------------
    # SQL path: "concat" (vulnerable, string-built) or "param" (safe, bound).
    SQL_IMPL = _env_flag("SQL_IMPL", "concat")
