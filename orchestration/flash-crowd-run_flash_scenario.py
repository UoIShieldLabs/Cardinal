...
def main():
    ...
    for i in range(args.surge_containers):
        ...
        try:
            ...
            timeline.event("burst_container_launched", run_id=run_id, name=name)
        except Exception as exc:
            timeline.event("burst_container_error", run_id=run_id, name=name,
                            error=str(exc))
